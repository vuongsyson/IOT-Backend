...
logSummary() {
    echo ""
        ...
        echo "JHipster Grafana - http://jhipster-grafana.iot."
        echo "#####################################################"
}
...
default() {
    ...
    kubectl apply -f authenticationapisservice-${suffix}/
    kubectl apply -f batteryapisservice-${suffix}/
    kubectl apply -f bssapisservice-${suffix}/
    kubectl apply -f devicestateapiservice-${suffix}/
    kubectl apply -f gateway-${suffix}/
    kubectl apply -f supportapisservice-${suffix}/
    kubectl apply -f swapapiservice-${suffix}/
    kubectl apply -f userapisservice-${suffix}/
    kubectl apply -f vehicleapiservice-${suffix}/
    kubectl apply -f vehiclestateapis-${suffix}/
