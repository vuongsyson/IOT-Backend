...
/**
 * REST controller for managing {@link com.sonpj.domain.Group}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GroupResource {
    ...
    public Mono<ResponseEntity<Group>> partialUpdateGroup(
        ...
        return groupRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Group> result = groupRepository
    ...
    /**
     * {@code GET  /groups} : get all the groups as a stream.
     * @return the {@link Flux} of groups.
     */
    @GetMapping(value = "/groups", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<Group> getAllGroupsAsStream() {
        log.debug("REST request to get all Groups as a stream");
