...
class EmployeeResourceIT {
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].isAssignment").value(hasItem(DEFAULT_IS_ASSIGNMENT.booleanValue())));
    }
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.isAssignment").value(DEFAULT_IS_ASSIGNMENT.booleanValue()));
    }
