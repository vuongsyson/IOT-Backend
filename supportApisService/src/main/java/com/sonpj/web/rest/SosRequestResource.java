...
public class SosRequestResource {
    ...
    private static final String ENTITY_NAME = "supportApisServiceSosRequest";
    ...
    public ResponseEntity<SosRequest> createSosRequest(@Valid @RequestBody SosRequest sosRequest) throws URISyntaxException {
        ...
        SosRequest result = sosRequestRepository.save(sosRequest);
    ...
    public ResponseEntity<SosRequest> updateSosRequest(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, sosRequest.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SosRequest> partialUpdateSosRequest(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        Optional<SosRequest> result = sosRequestRepository
            ...
            .map(sosRequestRepository::save);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, sosRequest.getId().toString())
        );
    }
    ...
    public ResponseEntity<SosRequest> getSosRequest(@PathVariable Long id) {
        log.debug("REST request to get SosRequest : {}", id);
        Optional<SosRequest> sosRequest = sosRequestRepository.findById(id);
    ...
    public ResponseEntity<Void> deleteSosRequest(@PathVariable Long id) {
