...
/**
 * REST controller for managing {@link com.sonpj.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "supportApisServiceEmployee";
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getIsAssignment() != null) {
                    existingEmployee.setIsAssignment(employee.getIsAssignment());
                }
